...
class AppColors {
  //* Main Colors
  static const Color primary = Color.fromRGBO(146, 1, 192, 1);
  static const Color secondary = Color.fromRGBO(220, 160, 236, 1);
  ...
  //* Black & White Colors
  static const Color black = Color(0xff040C17);
